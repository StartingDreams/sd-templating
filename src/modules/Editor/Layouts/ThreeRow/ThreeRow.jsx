...
export class ThreeRow extends Base {
  defaultStyles = () => {
    return fromJS([
      {
        name: "Outer",
  ...
  render = () => {
    ...
    const rows = renderStyles.get(2, defaultStyles.get(2)).toJS();
    return (
          ...
          <tr>
            <td style={{padding: 0}}>
              <table style={Object.assign(inner.styles, inner.editableStyles)}>
                <tbody>
                <tr>
                  <td width="100%" style={Object.assign(rows.styles, rows.editableStyles)}>
